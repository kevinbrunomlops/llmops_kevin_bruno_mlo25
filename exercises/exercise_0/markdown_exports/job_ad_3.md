...
- **Description:** A newly formed Data Platform team seeking professionals to build and maintain a modern data platform using tools like FiveTran, Python, DBT, GCP, Snowflake, and Tableau. Responsibilities include integration, infrastructure setup, and enabling data-driven decisions across stakeholders.
- **Job title:** The Data Platform team focuses on creating a unified data infrastructure to support BI, data science, and product integrations. Key technologies include GCP, Snowflake, DBT, Airflow, and Python.
- **Responsibilities:**
 -Lead data integration patterns and migrate source systems to the data platform
 -Design and maintain data platform infrastructure using CI/CD and IaC
 -Implement data product principles like discoverability and trustworthiness
 -Build data pipelines using Airflow or similar tools
 -Model data using DBT, SQL, and Python
 -Collaborate with stakeholders to design business-aligned data models
 -Ensure governance and trust in data through transformation workflows
 -Support analytical projects to solve business hypotheses
 -Design and maintain cloud-based data architectures (GCP/Snowflake)
 -Work with agile methodologies and agile project teams

- **Words in article:** 748
